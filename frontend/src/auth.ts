...
// Control whether to use the dev user or not
// Set this to 'false' in your .env.local file to disable the dev user
const USE_DEV_USER = import.meta.env.VITE_USE_DEV_USER !== 'false';
  ...
  providers: [
    {
      ...
      credentials: {},
      authorize: async () => {
        // Check if we should use the dev user
        if (USE_DEV_USER) {
        ...
        // When dev user is disabled, return null to indicate authentication failure
        // In a real app, this would be where you'd implement actual authentication
        console.log('Development user disabled, authentication required');
        return null;
      },
    },
  ],
