        ...
        <SidebarInset>
          <header className="sticky top-0 flex h-16 shrink-0 items-center gap-2 border-b bg-background/90 backdrop-blur-sm px-4 z-10 shadow-sm">
            {showLeftSidebar && (
              <>
                <SidebarTrigger
                  side="left"
                  className="-ml-1 hover:bg-muted/80 transition-colors"
                />
                <Separator
                  orientation="vertical"
                  className="mr-2 h-5 opacity-30"
                />
              </>
            )}
            <Breadcrumb>
          ...
          <div className="flex flex-1 flex-col h-[calc(100vh-4rem)]">
            {isInvalidSession ? (
              <div className="flex h-full w-full items-center justify-center p-8 text-center">
                <div className="max-w-md space-y-6 bg-card/30 backdrop-blur-sm p-8 rounded-xl border border-border/40 shadow-sm">
                  ...
                  <p className="text-muted-foreground">
                    The chat session you're looking for doesn't exist or has
                    been deleted.
                  </p>
                  <button
              ...
              <Chat sessionId={sessionId} sessionName={activeSession.name} />
            ) : (
              <div className="flex h-full w-full items-center justify-center p-8 text-center">
                <div className="max-w-md space-y-6 bg-card/30 backdrop-blur-sm p-8 rounded-xl border border-border/40 shadow-sm">
                  <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    started with your AI assistant.
                  </p>
                  <Button>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
